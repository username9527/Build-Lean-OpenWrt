...
git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/custom/luci-theme-argon
git clone -b 18.06 https://github.com/jerrykuku/luci-app-argon-config.git package/custom/luci-app-argon-config
...
# git clone -b master --single-branch https://github.com/ntlf9t/luci-app-easymesh package/custom/luci-app-easymesh
...
git clone -b main --single-branch https://github.com/sirpdboy/luci-app-advancedplus package/custom/luci-app-advancedplus
